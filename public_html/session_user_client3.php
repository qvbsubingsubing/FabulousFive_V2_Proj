...
$_SESSION["curr_email"] = "client3@gmail.com"; //permanent account property
$_SESSION["curr_account_id"] = "4"; //permanent account property
$_SESSION["curr_chat_account_id"] = "2"; //changeable by clicking who will be chatted
